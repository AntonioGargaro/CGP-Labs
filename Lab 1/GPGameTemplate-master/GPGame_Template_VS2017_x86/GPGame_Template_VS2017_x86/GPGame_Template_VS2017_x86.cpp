...
void startup() {
	...
	myLine1.Load(); myLine2.Load(); myLine3.Load(); myLine4.Load();
	myLine5.Load(); myLine6.Load(); myLine7.Load(); myLine8.Load();
	...
	myLine1.fillColor =
		...
		myLine6.fillColor =
		myLine7.fillColor =
		myLine8.fillColor = glm::vec4(3.0f, 1.0f, 1.0f, 3.0f);
	myLine1.lineColor = 
		myLine2.lineColor = 
		myLine3.lineColor = 
		myLine4.lineColor =
		...
		myLine6.lineColor =
		myLine7.lineColor =
		myLine8.lineColor = glm::vec4(0.2f, 0.2f, 0.2f, 3.0f);
	myLine1.lineWidth = 
		myLine2.lineWidth = 
		myLine3.lineWidth = 
		myLine4.lineWidth =
...
void updateSceneElements() {
	...
	// Border Lines
	// Calculate Line1
	myLine1.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(3.0f, 0.5f, 1.5f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::mat4(1.0f);
	myLine1.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line2
	myLine2.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(3.0f, 0.5f, -1.5f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::mat4(1.0f);
	myLine2.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line3
	myLine3.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(-3.0f, 0.5f, 1.5f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::mat4(1.0f);
	myLine3.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line4
	myLine4.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(-3.0f, 0.5f, -1.5f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::mat4(1.0f);
	myLine4.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line5
	myLine5.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(1.5f, 0.5f, 3.0f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::rotate(1.57f, glm::vec3(0.0f, 1.0f, 0.0f)) *
		glm::mat4(1.0f);
	myLine5.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line6
	myLine6.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(-1.5f, 0.5f, 3.0f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::rotate(1.57f, glm::vec3(0.0f, 1.0f, 0.0f)) *
		glm::mat4(1.0f);
	myLine6.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line7
	myLine7.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(1.5f, 0.5f, -3.0f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::rotate(1.57f, glm::vec3(0.0f, 1.0f, 0.0f)) *
		glm::mat4(1.0f);
	myLine7.proj_matrix = myGraphics.proj_matrix;

	// Calculate Line8
	myLine8.mv_matrix = myGraphics.viewMatrix *
		glm::translate(glm::vec3(-1.5f, 0.5f, -3.0f)) *
		glm::scale(glm::vec3(3.0f, 0.001f, 3)) *
		glm::rotate(1.57f, glm::vec3(0.0f, 1.0f, 0.0f)) *
		glm::mat4(1.0f);
	myLine8.proj_matrix = myGraphics.proj_matrix;
